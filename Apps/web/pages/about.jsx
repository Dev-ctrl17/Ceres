      ...
      <main>
        <section className="relative py-24 xs:py-28 sm:py-32 lg:py-40 xl:py-44 min-h-[60vh] xs:min-h-[65vh] sm:min-h-[70vh] flex items-center justify-center">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 xs:px-5 sm:px-6 lg:px-8 text-center">
            <h1 className="heading-lg mb-4 xs:mb-4 sm:mb-5 md:mb-6 text-white">Best Luxury Real Estate Agency Nigeria</h1>
        ...
        <section className="py-16 xs:py-18 sm:py-20">
          <div className="max-w-7xl mx-auto px-4 xs:px-5 sm:px-6 lg:px-8">
            <h2 className="heading-lg mb-8 xs:mb-8 sm:mb-10 md:mb-12 text-center">Our Team</h2>
            {loading ? (
        ...
        <section className="py-16 xs:py-18 sm:py-20 bg-secondary">
          <div className="max-w-7xl mx-auto px-4 xs:px-5 sm:px-6 lg:px-8">
            <h2 className="heading-lg mb-8 xs:mb-8 sm:mb-10 md:mb-12 text-center">Our Achievements</h2>
        ...
        <section className="py-16 xs:py-18 sm:py-20">
          <div className="max-w-4xl mx-auto px-4 xs:px-5 sm:px-6 lg:px-8">
            <h2 className="heading-lg mb-4 xs:mb-4 sm:mb-5 md:mb-6">Why Choose Luxury Properties Ltd?</h2>
        ...
        <section className="py-16 xs:py-18 sm:py-20 epan-section">
          <div className="max-w-4xl mx-auto px-4 xs:px-5 sm:px-6 lg:px-8">
            <h2 className="heading-lg mb-4 xs:mb-4 sm:mb-5 md:mb-6">EPAN Initiative</h2>
            <p className="text-muted-foreground leading-relaxed mb-6">
