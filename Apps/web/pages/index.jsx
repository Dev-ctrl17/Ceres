          ...
          <section className="py-24 bg-secondary/30">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                ...
                <Link href="/properties" aria-label="View all latest properties">
                  <Button variant="outline" className="group">
                    View All Properties 
                    <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
                  </Button>
                ...
                {services.map((service, index) => (
                  <Card key={index} className="bg-muted border-none shadow-none hover:bg-secondary transition-colors duration-300">
                    <CardContent className="p-8 flex flex-col h-full">
                      ...
                      <Link href="/services" className="text-primary font-medium hover:underline inline-flex items-center mt-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link href="/epan" aria-label="Become an EPAN member">
                      <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90">
                        Become a Member
                      </Button>
                    </Link>
                    <Link href="/about" aria-label="Learn more about EPAN">
