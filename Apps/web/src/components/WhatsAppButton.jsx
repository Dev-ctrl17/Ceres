...
const WhatsAppButton = () => {
  ...
  useEffect(() => {
    // Lazy load the icon after component mounts
    setIsLoaded(true);
  }, []);

  const whatsappNumber = "2349056201176";
  const message = "Hello%20Luxury%20Properties,%20I'm%20interested%20in%20one%20of%20your%20properties.";
  ...
  return (
    <a
      ...
      className={`
        ...
        hover:scale-110
        group
        md:bottom-[30px] md:right-[30px] md:w-14 md:h-14
        bottom-[20px] right-[20px] w-12 h-12
