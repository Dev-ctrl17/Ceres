...
const WhatsAppButton = () => {
  return (
    <>
      {/* Button 1 - Business Line */}
      <a
        href="https://wa.me/2349056201176?text=Hello%20Luxury%20Properties,%20I'm%20interested%20in%20one%20of%20your%20properties."
        target="_blank"
      ...
      >
        ...
        <span className="absolute right-full mr-3 px-3 py-1.5 bg-gray-800 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
          Sales: +234 905 620 1176
        </span>
      </a>

      {/* Button 2 - Support Line */}
      <a
        href="https://wa.me/2347039726375?text=Hello%20Luxury%20Properties,%20I'm%20interested%20in%20one%20of%20your%20properties."
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat with us on WhatsApp"
        className="
