...
/**
 * NYSC Legal & Administrative Support Job Listing Page
 * 
 * Styled specifically to match Luxury Properties Ltd brand guidelines.
 * Route: /careers/nysc-legal-admin
 */
export default function NyscLegalAdminPage() {
