      ...
      <main>
        <section className="relative py-32 lg:py-44 min-h-[70vh] flex items-center justify-center hero-section">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white hero-animate" style={{ letterSpacing: '-0.02em' }}>Sell Your Property</h1>
                ...
                <div className="space-y-4 mb-8">
                  {benefits.map((benefit, index) => (
                    <div key={index} className="flex items-start space-x-3 benefit-item">
                      <CheckCircle className="w-6 h-6 text-primary flex-shrink-0 mt-0.5 transition-transform duration-300 hover:rotate-12 hover:scale-110" />
                  ...
                  <CardContent className="p-6">
                    ...
                    <ol className="space-y-3 text-sm leading-relaxed">
                      {howItWorks.map((step, index) => (
                        <li key={index} className="how-it-works-item p-2 transition-all duration-300" style={{ animationDelay: `${(index + 1) * 0.2}s` }}>
                          {index + 1}. {step}
                        </li>
                      ))}
                    </ol>
